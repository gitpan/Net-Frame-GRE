#
# $Id: GRE.pm,v 1.2 2006/12/16 14:08:12 gomor Exp $
#
package Net::Frame::GRE;
use strict;
use warnings;
...
Net::Frame::GRE - GRE layer object
...
=head1 SYNOPSIS
   ...
   # Read a raw layer
   my $layer = Net::Frame::GRE->new(raw => $raw);
...
This modules implements the encoding and decoding of the GRE layer.
...
Load them: use Net::Frame::GRE qw(:consts);
